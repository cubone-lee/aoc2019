...
in space often involves transferring between orbits, the orbit maps here are useful 
for finding efficient routes between, for example, you and Santa. You download a map 
...
is orbiting. An orbital transfer lets you move from any object to an object orbiting
...
def get_input() -> Iterable[str]:
    with open('input/day6.txt', 'r') as challenge_input:
